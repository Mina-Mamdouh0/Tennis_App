...
class PlayerSearchMatch extends StatefulWidget {
  final Function(Player) onPlayerSelected;

  const PlayerSearchMatch({super.key, required this.onPlayerSelected});

  @override
  _PlayerSearchMatchState createState() => _PlayerSearchMatchState();
}
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                // Pop the PlayerSearchMatch screen to go back to the parent screen
